package com.thelab.hotel32.views.amenities
{
	...
	import com.thelab.hotel32.AmenityMask;
	...
	public class AmenityBox extends BasicBox
	{
		private var boxMask											: AmenityMask;
		public var mainAsset										: ContentDisplay;
		public var overAsset										: ContentDisplay;
		public var detailAsset										: ContentDisplay;
		...
		public function AmenityBox(name:String=null)
		{
			super(name);
		}
		...
		{
			return "[AmenityBox id: " + name + ", index: " + index + ", x: " + x + ", y: " + y + "]";
		}
...
//			boxMask.overHolder.addChild(overAsset);
			...
			hotspot.graphics.drawRect(0, 0, 244, 229);
			addChild(hotspot);
		}
